                        ...
                        {following && following.length > 0 ? (
                            following.map((followedUser) => (
                                <div
                                    ...
                                    className="following-card-wrapper"
                                >
                                    <Link
                                        to={`/other-user/${followedUser.userId}`}
                            ...
                            <Typography.Text>
                                Es sind keine Benutzer gefolgt.
                            </Typography.Text>
                        )}
                    </>
                )}
